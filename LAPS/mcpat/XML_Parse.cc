				...
				if (strstr(xNode3.getAttribute("name"),"core")!=NULL)
				{
					{ //For cpu0-cpui
						...
						for(k=0; k<itmp; k++)
						{
							...
							if (strcmp(xNode3.getChildNode("param",k).getAttribute("name"),"has_spm")==0) {sys.core[i].has_spm=atoi(xNode3.getChildNode("param",k).getAttribute("value"));continue;}
