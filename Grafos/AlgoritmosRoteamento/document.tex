...
\begin{figure}[htp]
\begin{center}
  \includegraphics[width=75mm]{Imagens/Cisco-CRS-3.jpeg}
...
\begin{itemize}
  \setlength{\itemsep}{0.7cm}%
  \item Como tornar escalável e administrável um conjunto de ~2bi de computadores interconectados?
...
\begin{itemize}
  ...
  \item Utilizado na ARPANET: Routing Information Protocol (RIP)
