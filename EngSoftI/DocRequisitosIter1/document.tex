...
\end{description}
\section{Back-end: Gerar de Relatórios}
\begin{description}
\item[Escopo:] Sistema Back-end
\item[Nível:] Meta do Administrador
\item[Ator Primário:] Administrador
...
% TODO mover para caso de uso certo. 
%   O pedido de suporte permanece pendente até um Administrador confirmar a
%   solução do Atendente.
\end{enumerate}
