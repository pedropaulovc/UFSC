...
public final class NumCelular {
	...
	public static NumCelular gerarNumeroAleatorio() {
		return new NumCelular(new Random().nextInt(maxNum) + 1 + minNum);
	}
	...
	public static void definirFaixaNumeros(int minNum, int maxNum) {
		NumCelular.maxNum = maxNum;
		NumCelular.minNum = minNum;
	}
